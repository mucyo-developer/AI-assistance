...
class DiabetesAssistant:
    def __init__(self, model_name="llama3.2:latest"):
        ...
        print(f"🤖 Diabetes Assistant initialized with model: {model_name}")
    ...
    def store_conversation(self, user_input: str, assistant_response: str, user_id: str = "default"):
    ...
    def detect_tool_call(self, user_input: str) -> Dict[str, Any]:
        ...
        tool_patterns = {
            ...
            "emergency_guidance": r"(emergency|urgent|help|911|severe)",
    ...
    def call_tool(self, tool_name: str, user_input: str, user_id: str = "default") -> str:
...
Provide a caring, informative response. Be empathetic and encouraging. Always remind them to consult healthcare professionals for medical advice."""
        ...
        try:
            ...
            return f"I apologize, but I encountered an error: {str(e)}. Please try again or consult with a healthcare professional."
    
    def start_conversation(self):
        """Start interactive conversation"""
        print("\n" + "="*60)
        print("🩺 DIABETES CARE ASSISTANT")
        print("="*60)
        print("I'm here to help you manage diabetes through conversation.")
        print("I can help with risk assessment, diet advice, exercise guidance,")
        print("medication reminders, and emergency information.")
        ...
        while True:
            try:
                ...
                if user_input.lower() in ['quit', 'exit', 'bye']:
                    print("\n👋 Take care! Remember to follow your healthcare provider's advice.")
                    break
                ...
                print(f"\n❌ Error: {str(e)}")
                print("Please try again or consult with a healthcare professional.\n")

if __name__ == "__main__":
    # Initialize and start the assistant
    assistant = DiabetesAssistant()
